...
from filings_b3._internal.utils.retry import RetryPolicy, call_with_backoff, retry_with_backoff
from filings_b3._internal.utils.retry._schedule import _compute_backoff_wait
...
def list_waits(monkeypatch: pytest.MonkeyPatch) -> list[float]:
	...
	monkeypatch.setattr(
		"filings_b3._internal.utils.retry.backoff.time.sleep",
