"""Data contract — instruments file, ``EqtyFwdInf`` block.
...
contract covers the records carrying **``EqtyFwdInf``** — termo de ações.
...
``IN260729.zip``: the block declares **18** fields, of which **15** carry a value in that session
...
INSTRUMENTS_FILE_EQTY_FWD = FileContract(
	"Pesquisa por Pregão Instruments File — EqtyFwdInf",
